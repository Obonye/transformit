...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <Card shadow="none" radius="none" className={"bg-transparent relative group  " + className}>
      ...
      <CardFooter className="pb-0 pt-2 px-4 flex-col items-start">
        <p className="text-[18px] text-custom-light-sky-blue uppercase font-bold">{title}</p>
